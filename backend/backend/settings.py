...
SECRET_KEY = 'django-insecure-*_)%jyqmuf6_bz^+2(jaq_i)g7$(scgz)zs97-7@d@)wk!7juo'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=3600),  # Set your access token lifetime
